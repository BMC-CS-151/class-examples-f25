public class Types {
  ...
  public static void printStudent(CSStudent s) {
      //does something
  }
  ...
  public static void main(String[] args) {
    ...
    //Student css = new Student("cinnabon", 1);
    Student css = new CSStudent("cinnabon", 1, "cchow");

    //if (css instanceof CSStudent)
    printStudent((CSStudent) css);
